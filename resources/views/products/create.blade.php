  ...
  <div class="card-body">
    ...
    <form class="needs-validation" action="{{ route('products.store') }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="uom" id="uom" placeholder="Unit of Measurement" value="{{ old('uom') }}">
      </div> 
      <div class="mb-3">
        <label for="unit_price" class="form-label">Unit Price</label>
        <input type="number" class="form-control" name="unit_price" id="unit_price" placeholder="Unit Price" value="{{ old('unit_price') }}">
      </div> 
